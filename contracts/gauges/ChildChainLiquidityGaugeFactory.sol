...
contract ChildChainLiquidityGaugeFactory is IChildChainLiquidityGaugeFactory {
     ...
     */
    function getGaugeImplementation()
        external
        view
        override
        returns (ILiquidityGauge)
    {
     ...
     */
    function getChildChainStreamerImplementation()
        external
        view
        override
        returns (IChildChainStreamer)
    {
     ...
     */
    function getPoolGauge(address pool)
        public
        view
        override
        returns (ILiquidityGauge)
     ...
     */
    function isGaugeFromFactory(address gauge)
        external
        view
        override
        returns (bool)
     ...
     */
    function getGaugeStreamer(address gauge)
        public
        view
        override
        returns (address)
     ...
     */
    function isStreamerFromFactory(address streamer)
        external
        view
        override
        returns (bool)
     ...
     */
    function getGaugePool(address gauge)
        external
        view
        override
        returns (IERC20)
