...
contract CvxLocker is ReentrancyGuard, Ownable {
    ...
    uint256 public constant lockDuration = rewardsDuration * 17; // 17 weeks
    ...
    function _lock(address _account, uint256 _amount, uint256 _spendRatio) internal {
        ...
        // spend some amount (boost payment) to boost your voting power ?
        ...
        // if has no lock or last lock has passed (done)
