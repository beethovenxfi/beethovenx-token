...
import { advanceBlock, advanceBlockTo, bn, deployChef, deployContract, deployERC20Mock } from "./utilities"
...
describe("BeethovenxMasterChef", function () {
  ...
  //        ....
  //    */
  //   const chef = await deployChef(beets.address, dev.address, treasury.address, marketing.address, 1000, 300)
  //   await beets.transferOwnership(chef.address)
  //
  //   const lp = await deployERC20Mock("Lp 1", "lp1", 10_000)
  ...
  //   expect(await beets.balanceOf(alice.address)).to.equal(3 * 1000 * 0.6)
  ...
  //   expect(await beets.balanceOf(alice.address)).to.equal(2800)
  //   // bob should have  2 * 1000 * (2 / 3) * 0.6 = 800
  //   expect(await beets.balanceOf(bob.address)).to.equal(800)
  //
  ...
  //  */
  //
  //   expect(await beets.totalSupply()).to.equal(10_000)
  //   expect(await beets.balanceOf(alice.address)).to.equal(3300)
  ...
  //   expect(await beets.balanceOf(chef.address)).to.equal(10_000 - 3300 - 800 - 2000 - 2000)
  //
  //   // 20% of all token rewards should have gone to dev
  //   expect(await beets.balanceOf(dev.address)).to.equal(2000)
  //
  //   // 20% of all token rewards should have gone to treasury
  //   expect(await beets.balanceOf(treasury.address)).to.equal(2000)
  //
  ...
  //   expect(await beets.totalSupply()).to.equal(20_000)
  //   expect(await beets.balanceOf(alice.address)).to.equal(3300)
  //   expect(await beets.balanceOf(bob.address)).to.equal(3542)
  //   expect(await beets.balanceOf(carol.address)).to.equal(0)
  //   expect(await beets.balanceOf(chef.address)).to.equal(5158)
  //   expect(await beets.balanceOf(dev.address)).to.equal(4000)
  //   expect(await beets.balanceOf(treasury.address)).to.equal(4000)
  //
  ...
  //   */
  //   expect(await beets.balanceOf(alice.address)).to.equal(6789)
  ...
  //   */
  //
  //   expect(await beets.balanceOf(bob.address)).to.equal(6926)
  //
  ...
  //   */
  //   expect(await beets.balanceOf(carol.address)).to.equal(16283)
  //
  //   expect(await beets.totalSupply()).to.equal(50_000)
  //   expect(await beets.balanceOf(dev.address)).to.equal(10_000)
  //   expect(await beets.balanceOf(treasury.address)).to.equal(10_000)
